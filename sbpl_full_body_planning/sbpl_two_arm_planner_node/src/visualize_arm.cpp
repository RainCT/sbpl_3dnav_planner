...
void VisualizeArm::visualizeCollisionModel(const std::vector<std::vector<double> > &path, sbpl_two_arm_planner::SBPLDualCollisionSpace &cspace, int throttle)
{
...
void VisualizeArm::visualizeCollisionModel(const std::vector<std::vector<double> > &path, sbpl_two_arm_planner::SBPLDualCollisionSpace &cspace, int throttle, int hue)
{
  std::vector<std::vector<double> > cylinders;
  visualization_msgs::MarkerArray marker_array;
  double r,g,b;
...
void VisualizeArm::visualizeCollisionModelFromJointTrajectoryMsg(trajectory_msgs::JointTrajectory &traj_msg, sbpl_two_arm_planner::SBPLDualCollisionSpace &cspace, int throttle)
{
  std::vector<std::vector<double> > traj;

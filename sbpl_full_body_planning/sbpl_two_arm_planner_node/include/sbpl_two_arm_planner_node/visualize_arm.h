...
class VisualizeArm
{
  public:
    ...
    void visualizeCollisionModel(const std::vector<std::vector<double> > &path, sbpl_two_arm_planner::SBPLDualCollisionSpace &cspace, int throttle);
    
    void visualizeCollisionModel(const std::vector<std::vector<double> > &path, sbpl_two_arm_planner::SBPLDualCollisionSpace &cspace, int throttle, int hue);

    /* \brief display the spherical collision model of each waypoint in a joint trajectory msg */
    void visualizeCollisionModelFromJointTrajectoryMsg(trajectory_msgs::JointTrajectory &traj_msg, sbpl_two_arm_planner::SBPLDualCollisionSpace &cspace, int throttle);

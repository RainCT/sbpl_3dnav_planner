...
{
  ros::NodeHandle nh;
  ros::ServiceClient filter_trajectory_client = nh.serviceClient<arm_navigation_msgs::FilterJointTrajectoryWithConstraints>("trajectory_filter/filter_trajectory_with_constraints");
...
bool addCollisionObjects(std::string filename, std::vector<double> &offset)
{
  ...
  ros::NodeHandle nh;
  ros::Publisher pub = nh.advertise<arm_navigation_msgs::CollisionObject>("collision_object", 2);
...
bool attachObject(std::string object_file, geometry_msgs::Pose rarm_object_pose)
{
  ...
  ros::Publisher pub = nh.advertise<arm_navigation_msgs::AttachedCollisionObject>("attached_collision_object", 1);
  ros::Publisher pub_sbpl = nh.advertise<arm_navigation_msgs::AttachedCollisionObject>("sbpl_attached_collision_object", 1);
